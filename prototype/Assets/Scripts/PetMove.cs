...
public class PetMove : MonoBehaviour
{
    ...
    void AutoPilot()
    {
        ...
        // Move the pet in it's forward direction
    ...
    float CalculateAngle()
    {
        ...
        // pet foward facing vector
        Vector3 tF = this.transform.forward;
        // Vector to the seek object
        Vector3 sD = userObj.transform.position - this.transform.position;
        ...
        // Draw a ray showing the pets's forward facing vector
    ...
    float CalculateDistance()
    {
        ...
        Vector3 sP = userObj.transform.position;
    ...
    void Update()
    {
        ...
        if (autoPilot)
        {
            ...
            userObj.transform.Translate(0, 0, translation);
            // Rotate saught object around our y-axis
            userObj.transform.Rotate(0, rotation, 0);
        }
    }
}
